...
_STARTDATA static PCI_VENTABLE	PciVenTable [] =
{
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x121A, 0x0010, "Rampage", "Rev.A AGPx4, 0.25ï¿œ, 200/2x200 core/RAM" } ,
	...
	{ 0x1223, 0x0001, "KatanaQp", "Real-Time Processing Blade in a standard single-slot AdvancedTCAï¿œ formfactor" } ,
	{ 0x1223, 0x0002, "KosaiPM", "Intelï¿œ Pentium-Mï¿œ based AMC Module" } ,
	...
	{ 0x8086, 0x10F5, "82567LM", "Intelï¿œ  82567LM-2 Gigabit Network Connection" } ,
	...
	{ 0x8086, 0x2415, "Intel 82801DBM SM/BUS Controller 24C3", "Aureal (AD1881 SOUNDMAX) Placa Mï¿œe Asaki P3-141" } ,
	...
	{ 0x8086, 0x7123, "82810-DC100", "Intelï¿œ 82810 Graphics Controller" } ,
...
//#	{ 0x14F1, 0x50452, "1179FF31", "Conextant High Definition Audio-Venice 5045" } ,
	...
	{ 0x1328, 0x2048, "", "" } ,
	{ 0x1328, 0x8888, "rev 1.5", "cPEGï¿œ C 3.0 DVD/MPEG2 decoder" } ,
	...
	{ 0x1002, 0x5B74, "FireGL V3100", "ATI 128MB PCI Expressï¿œ x16 ATI FireGL V3100" } ,
	...
	{ 0x1002, 0x95c4, "ATI Mobilityï¿œ Radeonï¿œ HD 3450", "ATI Mobilityï¿œ Radeonï¿œ HD 3450" } ,
	...
	{ 0x1055, 0x0926, "I donï¿œt know pentium 133 intel   everex setpnot mx", "ISA Bridge" } ,
	...
	{ 0x13D1, 0xAB08, "SMC8035TX", "EZ Cardï¿œ 10/100 Fast Ethernet CardBus Adapter" } ,
	...
	{ 0x10DE, 0x0057, "nForce4 Ultra", "NVidia Network Bus Enumerator Description du pï¿œriphï¿œrique	nVIDIA nForce4 SLI (CK8-04) - LAN Controll" } ,
	...
	{ 0x10DE, 0x0111, "NV11DDR", "GeForce2 MX 100/200Ã?ï¿œ  (DDR)" } ,
	...
	{ 0x10DE, 0x0428, "NVIDIAï¿œ GeForce 8400M G", "NVIDIAï¿œ GeForce 8400M G" } ,
	...
	{ 0x1106, 0x3118, "CN400", "Via Built-In VGA S3 Graphics UniChromeï¿œ Pro IGP Series CN400" } ,
	...
	{ 0x14E4, 0x3352, "BCM3352", "BCM3352 QAMLinkï¿œ Single-Chip 4-Line VoIP" } ,
	...
	{ 0x14E4, 0x5802, "BCM5802", "The BCM5802 Security Processor integrates Broadcomï¿œs IPSec engine (DES, 3DES, HMAC-SHA-1, HMAC-MD5)," } ,
	...
	{ 0x1166, 0x0241, "BC4852", "8-Channel RAIDCoreï¿œ SATA RAID Host Bus Adapter" } ,
...
_STARTDATA static PCI_CLASSCODETABLE PciClassCodeTable [] =
{
...
_STARTDATA const char *	PciCommandFlags [] =
{
	"I/O Access",
	"Memory Access",
	"Bus Mastering",
...
_STARTDATA const char *	PciStatusFlags [] =
{
	"Reserved 0",
	"Reserved 1",
	"Reserved 2",
...
_STARTDATA const char *	PciDevSelFlags [] =
{
