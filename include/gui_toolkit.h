...
typedef gui_event_result (*fp_gui_event)(gui_base_t base, gui_event e,
					 void *param);

void gui_toolkit_init(void *hw_buffer, unsigned hw_size, int width, int height,
		      unsigned bg_color, char *background);

gui_panel_t gui_create_panel(gui_base_t parent, int x, int y, int width,
			     int height, unsigned color);
