...
#define UTS_MACHINE MOS_UTS_MACHINE

#define IDT_SIZE 256

#define KHEAP_BEGIN MOS_KERNEL_HEAP_BEGIN

#define KHEAP_END (KHEAP_BEGIN + MOS_KERNEL_HEAP_SIZE)
...
#define TASK_UNMAPPED_BASE MOS_TASK_UNMAPPED_BASE
...
#define PAGE_SIZE_MASK MOS_PAGE_SIZE_MASK
