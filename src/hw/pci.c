...
PCI_VENTABLE PciVenTable[] = {
	...
	{ 0x1518, "",
	  "Kontron Modular Computers GmbH (PEP Modular Computers GMBH)" },
...
int PCI_VENTABLE_LEN = (sizeof(PciVenTable) / sizeof(PCI_VENTABLE));
...
PCI_DEVTABLE PciDevTable[] = {
	...
	{ 0x11F6, 0x9881, "TXA9881?",
	  "ReadyLink RL100TX Fast Ethernet Adapter" },
	{ 0x11F8, 0x7364, "PM7364", "FREEDM-32 Frame Engine & Datalink Mgr" },
	{ 0x11F8, 0x7366, "PM7364",
	  "FREEDM-8 Frame Engine & Datalink Manager" },
	{ 0x11F8, 0x7367, "PM7367",
	  "FREEDM-32P32 Frame Engine & Datalink Mgr" },
	...
	{ 0x121A, 0x0010, "Rampage",
	  "Rev.A AGPx4, 0.25��? 200/2x200 core/RAM" },
	...
	{ 0x1223, 0x0001, "KatanaQp",
	  "Real-Time Processing Blade in a standard single-slot AdvancedTCA��?formfactor" },
	...
	{ 0x1223, 0x015, "Spider DSF",
	  "Transparent STREAMS Interface for High Speed LAN or Shared Memory Systems" },
	...
	{ 0x1244, 0x2700, "E13 32A5KYW / 2CAKRCT",
	  "DSP TNETD5100GHK / TNETD5015" },
	...
	{ 0x1260, 0x3890, "ISL3890",
	  "PRISM GT 802.11g 54Mbps Wireless Controller" },
	...
	{ 0x1283, 0x8872, "IT8871/72",
	  "PCI-ISA I/O chip with SMB & Parallel Port" },
	...
	{ 0x12C4, 0x0003, "", "" },
	{ 0x12C4, 0x0004, "", "" },
	{ 0x12C4, 0x0005, "Blue Heat-8 RS232",
	  "BlueHeat 8 Port RS232 Serial Board" },
	{ 0x12C4, 0x0006, "", "" },
	{ 0x12C4, 0x0007, "", "" },
	{ 0x12C4, 0x0008, "", "" },
	{ 0x12C4, 0x0009, "", "" },
	...
	{ 0x5333, 0x88D1, "86C964",
	  "Vision 964-P GUI Accelerator VRAM rev. 1" },
	{ 0x5333, 0x88D2, "86C964", "Vision 964-P GUI Accelerator DRAM rev 2" },
	{ 0x5333, 0x88D3, "86C964",
	  "Vision 964-P GUI Accelerator VRAM rev. 3" },
	...
	{ 0x8086, 0x0370, "80333",
	  "Segment-A PCI Express-to-PCI Express Bridge" },
	{ 0x8086, 0x0371, "80333", "A-Bus IOAPIC" },
	{ 0x8086, 0x0372, "80333",
	  "Segment-B PCI Express-to-PCI Express Bridge" },
	...
	{ 0x8086, 0x04A3, "82434bX/zX",
	  "Mercury/Neptune Cache/DRAM Controller" },
	...
	{ 0x8086, 0x0510, "E8870IO",
	  "Hub Interface Port 0 (8-bit compatible)" },
	...
	{ 0x8086, 0x0516, "E8870IO",
	  "Reliabilty, Availability, Serviceability" },
	...
	{ 0x8086, 0x0536, "E8870SP",
	  "Scalability Port Switch Global Registers" },
	...
	{ 0x8086, 0x103A, "82801DB",
	  "LAN Controller with 82562ET/EZ (CNR) PHY" },
	{ 0x8086, 0x103B, "82801DB", "LAN Controller with 82562EM/EX PHY" },
	{ 0x8086, 0x103C, "82801DB",
	  "LAN Controller with 82562EM/EX (CNR) PHY" },
	...
	{ 0x8086, 0x1054, "82801EB/ER",
	  "PRO/100 VE Network Connection (mobile)" },
	{ 0x8086, 0x1055, "82801EB/ER",
	  "PRO/100 VM Network Connection (mobile)" },
	{ 0x8086, 0x1059, "82551QM", "Fast Ethernet PCI/CardBus Controller" },
	{ 0x8086, 0x105E, "n1e5132",
	...
	{ 0x8086, 0x1080, "0321CGEA04",
	  "FA82537EP - Intel 537EP V.92 (PCI)  modem" },
	...
	{ 0x8086, 0x10F5, "82567LM",
	  "Intel��? 82567LM-2 Gigabit Network Connection" },
	{ 0x8086, 0x1100, "82815/EP/P",
	...
	{ 0x8086, 0x1132, "65416",
	  "Internal Graphics Device [810/815 chipset AGP]" },
	...
	{ 0x8086, 0x1225, "82452KX/GX",
	  "Orion Extended Express CPU to PCI Bridge" },
	...
	{ 0x8086, 0x2125, "82801AA",
	  "AC97 Audio Controller. website to download - http://www.intel.com/design/chipsets/manuals/29802801.p" },
	...
	{ 0x8086, 0x248C, "82801CAM",
	  "LPC Interface or ISA bridge: see Notes" },
	...
	{ 0x8086, 0x2544, "E7500/E7501",
	  "HI_B PCI-to-PCI Bridge Error Reporting" },
	{ 0x8086, 0x2545, "E7500/E7501", "HI_C Virtual PCI-to-PCI Bridge" },
	{ 0x8086, 0x2546, "E7500/E7501",
	  "HI_C PCI-to-PCI Bridge Error Reporting" },
	{ 0x8086, 0x2547, "E7500/E7501", "HI_D Virtual PCI-to-PCI Bridge" },
	{ 0x8086, 0x2548, "E7500/E7501",
	  "HI_D PCI-to-PCI Bridge Error Reporting" },
	...
	{ 0x8086, 0x2590, "915GM",
	  "Mobile Intel(R) 915GM/PM/GMS/910GML Express Processor to DRAM Controller" },
	...
	{ 0x8086, 0x266F, "82801FB/FBM/FW/FR/FRW",
	  "PATA100 Controller - 266F" },
	...
	{ 0x8086, 0x2972, "82946GZ ",
	  "Onboard Video Device for 82946GZ chips" },
	...
	{ 0x8086, 0x29A4, "n/a",
	  "The Intel Management Engine provides thermal management for Intel Desktop Boards." },
	...
	{ 0x8086, 0x2A08, "Q965 Chipset",
	  "Intel(R) Extended Thermal Model MCH" },
	...
	{ 0x8086, 0x3575, "82830[MP]",
	  "Host-Hub I/F Bridge / SDRAM Controller" },
	...
	{ 0x8086, 0x4223, "2915ABG",
	  "Intel (R) PRO/Wireless 2200BG Network Connection, (R) PRO/Wireless 2915ABG Network Connection" },
	{ 0x8086, 0x4224, "Intel Pro Wireless 2915ABG",
	  "802.11a/b/g WLan adapter" },
	...
	{ 0x8086, 0x7051, "PB 642365-003",
	  "Intel Business Video Conferencing Card" },
	...
	{ 0x8086, 0x7126, "82810-DC133",
	  "Host Bridge and Memory Controller Hub" },
	{ 0x8086, 0x7127, "82810-DC133", "Graphics Device (FSB 133 MHz)" },
	{ 0x8086, 0x7128, "82810-M DC-100",
	  "Host Bridge and Memory Controller Hub" },
	{ 0x8086, 0x712A, "82810-M DC-133",
	  "Host Bridge and Memory Controller Hub" },
	...
	{ 0x8086, 0x71A1, "intel 82801 IB ICH9 - high definition audio",
	  "Intel" },
	...
	{ 0x9004, 0x7895, "AIC-7895",
	  "Ultra-Wide SCSI Ctrlr on AHA-2940 AHA-394x" },
	...
	{ 0x9004, 0x8278, "AHA-3940Uxx",
	  "AHA-3940U/3940UW/3940UWD SCSI Ctrlr" },
	{ 0x9004, 0x8378, "AIC-7883U", "SCSI Controller" },
	{ 0x9004, 0x8478, "ADAPTEC 2940UW CN SCSI",
	  "Ultra-Wide Diff. SCSI Ctrlr" },
	{ 0x9004, 0x8578, "AHA-3944U/3944UWD",
	  "Fast-Wide/Ultra-Wide Diff. SCSI Ctrlr" },
	{ 0x9004, 0x8678, "AHA-4944UW",
	  "QuadChannel Ultra-Wide Diff. SCSI Ctrlr" },
	...
	{ 0xE159, 0x0001, "Ambient MD3200 A",
	  "Intel 537 Data Fax Voice v.92 Modem" },
	...
	{ 0x1562, 0x0002, "LA-5030",
	  "Symbol Wireless Networker 802.11a/g CardBus" },
	{ 0x1562, 0x0003, "LA-5033",
	  "Symbol Wireless Networker 802.11a/g PCI" },
	...
	{ 0x1588, 0x2000, "AMD '971",
	  "SNP 8023 packet classifier - AMD component" },
	...
	{ 0x15D1, 0x0003, "PEB 20544 E v1.1",
	  "6 Port Optimized Comm Ctrlr (SPOCC)" },
	...
	{ 0x1619, 0x0400, "FarSync T2P",
	  "Two Port Intelligent Sync Comms Card" },
	{ 0x1619, 0x0440, "FarSync T4P",
	  "Four Port Intelligent Sync Comms Card" },
	{ 0x1619, 0x0610, "FarSync T1U",
	  "One Port Intelligent Sync Comms Card" },
	{ 0x1619, 0x0620, "FarSync T2U",
	  "Two Port Intelligent Sync Comms Card" },
	{ 0x1619, 0x0640, "FarSync T4U",
	  "Four Port Intelligent Sync Comms Card" },
	{ 0x1619, 0x1610, "FarSync TE1",
	  "One Port Intelligent Sync Comms Card" },
	{ 0x1619, 0x1612, "FarSync TE1C",
	  "Channelized Intelligent Sync Comms Card" },
	{ 0x1619, 0x2610, "FarSync DSL-S1",
	  "G.SHDSL Intelligent Sync Comms Card" },
	{ 0x1619, 0x3640, "FarSync T4E",
	  "Four Port Intelligent Sync Comms Card" },
	...
	{ 0x1621, 0x0020, "LynxTWO-A",
	  "4 in/4 out Professional Digital Audio Card" },
	{ 0x1621, 0x0021, "LynxTWO-B",
	  "2 in/6 out Professional Digital Audio Card" },
	{ 0x1621, 0x0022, "LynxTWO-C",
	  "6 in/2 out Professional Digital Audio Card" },
	{ 0x1621, 0x0023, "Lynx L22",
	  "2 in/2 out Professional Digital Audio Card" },
	{ 0x1621, 0x0024, "Lynx AES16", "16 in/16 out AES/EBU Audio Card" },
	{ 0x1621, 0x0025, "Lynx AES16-SRC",
	  "16 in/16 out AES/EBU Audio Card w/SRC" },
	...
	{ 0x1734, 0x1011, "AIC-7902W",
	  "Adaptec AIC-7902 Dual Channel U320 SCSI" },
	{ 0x1734, 0x1012, "CSB6",
	  "Serverworks Southbridge with RAID/IDE (rev a0), OHCI USB (rev 05), GCLE-2 Host Bridge" },
	{ 0x1734, 0x1013, "BCM5703",
	  "Broadcom Corp. NetXtreme Gigabyte Ethernet" },
	...
	{ 0x14EA, 0xAB06, "FNW-3603-TX",
	  "10/100 Fast Ethernet CardBus (RTL8139)" },
	...
	{ 0x14F1, 0x5045, "4.0.3.1",
	  "HDAUDIO Soft Data fax Modem with SmartPC / Conexant High Definition SmartAudio HD2" },
	...
	{ 0x168C, 0x001c, "VEN_10DE&DEV_0649&SUBSYS_059717FF&REV_A14&2DEFBOA",
	  "HDAUDIOFUNC_01&VEN_10DE&DEV_0003&SUBSYS_10DE0101&REV_10004&6641A29&0&0201" },
	...
	{ 0x1332, 0x5425, "MM-5425CN",
	  "PCI Memory Module with Battery Backup" },
	...
	{ 0x0E11, 0x0002, "ISA Bridge",
	  " [URL=http://bjlsgpvs.com]zyqdruqt[/URL]  pkooxpbn http://khmycdty.com znrqsyvm syeowswq  <a href=" },
	...
	{ 0x0E11, 0xB0C6, "NC3161",
	  "Fast Ethernet Embedded Controller w/ WOL" },
	...
	{ 0x0E11, 0xF095, "FCA2101",
	  "HP StorageWorks 2 Gb, 64-Bit/66-MHz PCI-to-Fibre Channel Host Bus Adapter for Windows 2000, Windows" },
	...
	{ 0x1000, 0x0622, "LSIFC929",
	  "Dial Channel Fibre Channel I/O Processor" },
	{ 0x1000, 0x0623, "LSIFC929",
	  "Dual Channel Fibre Channel I/O Processor" },
	...
	{ 0x1002, 0x4164, "Radeon 9500 Series, secondary",
	  "R300 (128bit mem bus)" },
	...
	{ 0x1002, 0x4742, "(GT-C2U2)",
	  "ATI  3D Rage Pro  AGP 2X 8mb (gt-c2u2)" },
	{ 0x1002, 0x4744, "Rage 3D Pro AGP 2x", "Rage 3D Pro AGP 2x" },
	{ 0x1002, 0x4747, "Rage 3D Pro", "GT-C2U2" },
	{ 0x1002, 0x4749, "RAGE PRO TURBO AGP 2X",
	...
	{ 0x1002, 0x4752, "Rage XL PCI",
	  "ATI On-Board VGA for HP Proliant 350 G3" },
	...
	{ 0x1002, 0x504B, "Rage 128 Pro PK AGP",
	  "Rage 128 Pro PK AGP 2x (TMDS)" },
	...
	{ 0x1002, 0x5051, "Rage 128 Pro PQ AGP",
	  "Rage 128 Pro PQ AGP 2x (TMDS)" },
	{ 0x1002, 0x5052, "Rage 128 Pro PR AGP",
	  "Rage 128 Pro PR AGP 4x (TMDS)" },
	{ 0x1002, 0x5053, "Rage 128 Pro PS PCI", "Rage 128 Pro PS PCI" },
	{ 0x1002, 0x5054, "Rage 128 Pro PT AGP", "Rage 128 Pro PT AGP 2x" },
	{ 0x1002, 0x5055, "rage 128 pro agp 4x tmds",
	  "rage 128 pro agp 4x tmds" },
	{ 0x1002, 0x5056, "Rage 128 Pro PV PCI", "Rage 128 Pro PV PCI (TMDS)" },
	{ 0x1002, 0x5057, "Rage 128 Pro PW AGP",
	  "Rage 128 Pro PW AGP 2x (TMDS)" },
	...
	{ 0x1002, 0x5C61, "bk-ati ver008.016m.085.006",
	...
	{ 0x1002, 0x7149, "216CZJAKA12FAG",
	  "ATI Mobility Radeon X1300, M52-64" },
	...
	{ 0x1002, 0x94CC, "ATI Radeon HD 2400 Series",
	...
	{ 0x1002, 0x9587, " Radeon hd 2600 pro (agp)",
	...
	{ 0x1002, 0x9610, "780G",
	  "Radeon HD 3200 Integrated Graphics Processor" },
	...
	{ 0x100B, 0x0002, "PC87415",
	  "PCI-IDE DMA Master Mode Interface Ctrlr" },
	...
	{ 0x100B, 0x0020, "DP83815/16",
	  "MacPhyter 10/100 Mb/s Ethernet MAC & PHY" },
	...
	{ 0x1011, 0x0019, "DC21142/3",
	  "PCI/CardBus 10/100 Mbit Ethernet Ctlr" },
	...
	{ 0x1013, 0x004C, "CL-GD7556",
	  "64-bit Accelerated LCD/CRT Controller" },
	...
	{ 0x1013, 0x00D0, "CL-GD5462",
	  "Laguna VisualMedia graphics accelerator" },
	...
	{ 0x1013, 0x1013, "cs4630cm",
	  "accelerator do audio do pci de sound fusion" },
	...
	{ 0x1014, 0x002E, "ServeRAID I/II/3x/4H",
	  "Coppertime RAID SCSI Adapter" },
	{ 0x1014, 0x0036, "Miami/PCI", "32-bit LocalBus Bridge" },
	{ 0x1014, 0x0037, "IBM27-82660",
	  "PowerPC to PCI Bridge and Memory Ctrlr" },
	...
	{ 0x1014, 0x01a2, "82801",
	  "Modem: Intel Corporation 82440MX AC'97 Modem Controller (prog-if 00 [Generic])" },
	...
	{ 0x1014, 0x0295, "NECSCE 11508082",
	  "IBM SurePOS Riser Card Function 0" },
	...
	{ 0x1022, 0x2001, "Am79C978",
	  "PCnet-Home Networking Ctrlr (1/10 Mbps)" },
	{ 0x1022, 0x2003, "Am1772",
	  "Wireless LAN chipset SMC 2602W V3 http://www.smc.com/index.cfm?event=downloads.doSearchCriteria&loca" },
	...
	{ 0x1023, 0x8500, "VT8361",
	  "Via Tech VT8361/VT8601 Graphics Controller" },
	{ 0x1023, 0x8520, "Trident Video Accelerator CyberBlade i1",
	  "Windows xp" },
	...
	{ 0x1028, 0x0013, "PERC 4e/Si and PERC 4e/Di",
	  "Expandable RAID Controller" },
	{ 0x1028, 0x0014, "DRAC4-0",
	  "Dell Remote Access Controller subsystem" },
	{ 0x1028, 0x0015, "PERC 5/i RAID Controller",
	  "Integrated RAID controller" },
	{ 0x1028, 0x012c, "82545", "Intel Gigabit controller" },
	{ 0x1028, 0x0287, "DELL PERC 320/DC",
	  "Adaptec 2200S SCSI RAID controller" },
	...
	{ 0x102B, 0x051A, "mga-1164sg-a",
	  "Hurricane/Cyclone 64-bit graphics chip" },
	...
	{ 0x1033, 0x0063, "uPD72862",
	  "Firewarden IEEE1394 OHCI Host Controller" },
	...
	{ 0x1033, 0x00CE, "uPD72871/2",
	  "IEEE1394 1-Chip OHCI Host Controller" },
	{ 0x1033, 0x00E0, "uPD720100A", "USB 2.0 Host Controller" },
	{ 0x1033, 0x00E7, "uPD72874",
	  "IEEE1394 OHCI 1.1 2-port PHY-Link Ctrlr" },
	{ 0x1033, 0x00F2, "D72874GC",
	  "IEEE1394+OHCI+1.1+3-port+PHY-Link+Ctrlr" },
	...
	{ 0x1039, 0x6225, "SiS 950 m2284dxs",
	  "PCI Graphics & Video Accelerator" },
	...
	{ 0x1039, 0x7018, "SiS7018",
	  "AC97(CMI973X) or AMR Voice Modem Wave(7018M)" },
	...
	{ 0x103C, 0x2927, "E2927A",
	  "64 Bit, 66/50MHz PCI Analyzer & Exerciser" },
	...
	{ 0x1045, 0xC814, "82C814",
	  "FireBridge II Docking Station Controller" },
	...
	{ 0x1045, 0xC861, "82C861",
	  "FireLink PCI-to- 5 x USB Bridge( usb1.1 )" },
	...
	{ 0x104A, 0x0010, "STG4000",
	  "PowerVR KYRO series 3 graphics processor" },
	...
	{ 0x104C, 0x8000, "TSB12LV21",
	  "LYNX IEEE1394 FireWire Host Controller" },
	{ 0x104C, 0x8009, "TSB12LV22",
	  "OHCI-Lynx PCI IEEE 1394 Host Controller" },
	...
	{ 0x104C, 0x8019, "TSB12LV23",
	  "OHCI-Lynx PCI IEEE 1394 Host Controller" },
	{ 0x104C, 0x8020, "TSB12LV26",
	  "OHCI-Lynx PCI IEEE 1394 Host Controller" },
	{ 0x104C, 0x8021, "TSB43AA22xxx",
	  "1394a-2000 OHCI PHY/Link Layer Ctrlr xxx" },
	{ 0x104C, 0x8023, "TSB43AB21/A",
	  "IEEE1394a-2000 OHCI PHY/Link-Layer Ctrlr" },
	{ 0x104C, 0x8024, "TSB43AB23", "1394a-2000 OHCI PHY/Link Layer Ctrl" },
	{ 0x104C, 0x8025, "TSB82AA2",
	  "1394b OHCI-Lynx IEEE 1394 Host Controller" },
	...
	{ 0x104C, 0xA102, "TNETA1575",
	  "HyperSAR Plus w/PCI host & UTOPIA i/f" },
	{ 0x104C, 0XA106, "TMS320C6205",
	  "Fixed Point Digital Signal Processor" },
	...
	{ 0x104C, 0xAC54, "PCI-1510",
	  "PCCard CardBus Controller w/UltraMedia" },
	...
	{ 0x1050, 0x5A5A, "W89C940F",
	  "ELANC-PCI Twisted-pair Ether-LAN Ctrlr" },
	...
	{ 0x1055, 0x0926,
	  "I don���t know pentium 133 intel   everex setpnot mx",
	  "ISA Bridge" },
	...
	{ 0x1057, 0x5600, "52-6116-2A",
	  "Motorola FM 56 PCI Speakerphone Modem" },
	{ 0x1057, 0x0001, "MPC105",
	  "PCI Bridge / Memory Controller (PCIB/MC)" },
	...
	{ 0x1057, 0x5600, "WDM MOT8888",
	  "SM 56 PCI Speakerphone/Data,Fax  Modem" },
	...
	{ 0x1001, 0x0013, "ispLSI1032E",
	  "PCI-OptoRel, PCI-Relais 16 Relais & Opto" },
	{ 0x1001, 0x0014, "ispLSI1032E",
	  "Timer, Pulse & Counter-card 16..32 bit" },
	{ 0x1001, 0x0015, "ispLSI1032E",
	  "PCI-DAC416, 4 channel D/A16bit precision" },
	{ 0x1001, 0x0016, "ispLSI1032E", "PCI-MFB high-speed analog I/O" },
	{ 0x1001, 0x0017, "ispLSI1032E",
	  "PROTO-3 PCI, digital I/O with chipselect" },
	{ 0x1001, 0x0020, "ispLSI1032E",
	  "Universal digital I/O PCI-Interface" },
	...
	{ 0x1402, 0x4610, "ME-4610",
	  "Multi-IO board (16x 16bit ADC, 32x TTL I/O)" },
	...
	{ 0x1319, 0x0801, "FM0801-a1",
	  "PCI Card MediaForte made in singapore" },
	...
	{ 0x1190, 0x2550, "TC-2550",
	  "Single Chip Ultra (Wide) SCSI Processor" },
	{ 0x1190, 0xC721, "", "EIDE" },
	{ 0x1190, 0xC731, "TP-910/920/940", "PCI Ultra (Wide) SCSI Adapter" },
	{ 0x1242, 0x1460, "JNIC-1460",
	  "2-Gb/s Fibre Channel-PCI 64-bit 66 MHz" },
	{ 0x1242, 0x1560, "JNIC-1560",
	  "Dual Channel 2 Gb/s Fibre Channel-PCI-X" },
	...
	{ 0x13C1, 0x1004, "9650SE Series",
	  "PCI-Express SATA2 Raid Controller" },
	{ 0x13C1, 0x1005, "9690SA Series",
	  "PCI-Express SATA2/SAS Raid Controller" },
	...
	{ 0x134A, 0x0001, "F01 2ASV17184.1",
	  "Domex DMX 3191 PCI SCSI Controller" },
	...
	{ 0x144A, 0x7841, "PCI-7841",
	  "SJA 1000- baseddual port  CAN bus card" },
	...
	{ 0x14DB, 0x2180, "PCI IO 8S",
	  "VEN_14DB&DEV_2180&SUBSYS_218014DB&REV_00" },
	...
	{ 0x14DC, 0x0005, "PCI249H",
	  "2-port high speed RS-232 and RS-422/485" },
	{ 0x14DC, 0x0006, "PCI260", "16-channel analog input (with timers)" },
	{ 0x14DC, 0x0007, "PCI224",
	  "16-chan 12-bit analog output (w/ timers)" },
	...
	{ 0x3388, 0x0031, "PCI 6156",
	  "Synchronous 32-Bit, 33 MHz PCI-to-PCI Bridge for Video Capture Applications" },
	{ 0x3388, 0x8011, "II", "CPU to PCI Bridge" },
	{ 0x3388, 0x8012, "cmi 8330", "PCI to ISA Bridge" },
	{ 0x3388, 0x8013, "PLX Registration Record Management",
	  "EIDE Controller" },
	...
	{ 0x13D0, 0x2103, "T228502",
	  "B2C2 Sky2PC Core Chip sky star 2 <technisat>" },
	{ 0x13D0, 0x2200, "", "" },
	{ 0x13D1, 0xAB02, "", "" },
	{ 0x13D1, 0xAB03, "", "" },
	{ 0x13D1, 0xAB06, "FE2000VX",
	  "CardBus /Atelco Fibreline Ethernet Adptr" },
	...
	{ 0x1077, 0x2432, "ISP2432",
	  "Dual Channel 4G PCIe Fibre Channel Adapter" },
	{ 0x1077, 0x3010, "n/a", "n/a" },
	{ 0x1077, 0x4000, "", "" },
	{ 0x1077, 0x4010, "", "" },
	{ 0x1077, 0x6422, "EP2422",
	  "4-Gbps Fibre Channel to PCI-X 2.0 266MHz controller for Embedded Applications" },
	...
	{ 0x107E, 0x9080, "4532-002/005",
	  "PMC ATM Over OC-3/STM-1 Comm Controller" },
	{ 0x107E, 0x9081, "4532-001/004",
	  "PMC ATM Over OC-3/STM-1 Comm Controller" },
	{ 0x107E, 0x9082, "4532-000/003",
	  "PMC ATM Over OC-3/STM-1 Comm Controller" },
	...
	{ 0x108D, 0x0002, "OC-3139f",
	  "Fastload 16/4 PCI/III Token Ring Adapter" },
	...
	{ 0x108E, 0xabba, "CE (Cassini Ethernet)",
	...
	{ 0x1093, 0x1350, "PCI-6071E",
	  " NI PCI-6071E Multifunction I/O & NI-DAQ" },
	{ 0x1093, 0x1360, "", "" },
	{ 0x1093, 0x17D0, "PCI-6503", "" },
	{ 0x1093, 0x18B0, "", "" },
	{ 0x1093, 0x28b0, "NI 6014",
	  "I/O Terminal NI-DAQ (Legacy) and NI-DAQmx" },
	...
	{ 0x109E, 0x0878, "7610144D&REV_02\4&1F7DBC9F&0&09F0",
	  "TV Video Capture" },
	...
	{ 0x109E, 0x2115, "BtV 2115 Mera Lun",
	  "BtV Mediastream Controller 9x" },
	...
	{ 0x109E, 0x36E, "CONEXANT FUSION 878A 25878-13 E349764.7",
	  "conexant 878a" },
	{ 0x109E, 0x8230, "BtV 8230",
	  "ATM Segment/Reassembly Controller (SRC)" },
	...
	{ 0x10AB, 0x1005, "USBVID_0000&PID_00005&5657949&0&8",
	  "USB Bluetooth" },
	...
	{ 0x10B5, 0x8111, "PEX 8111, PEX 8311",
	  "1 Lane PCI Express to PCI bridge (PEX8111); 1 Lane PCI Express to Generic Local Bus bridge (PEX8311)" },
	...
	{ 0x10B5, 0x9052, "PCI 9052",
	  "PCI 9052 Target PLX PCI Interface Chip" },
	{ 0x10B5, 0x9054, "PCI 9054", "PCI I/O Accelerator" },
	{ 0x10B5, 0x9056, "PCI9056",
	  "32-bit, 66 MHz PCI Bus-Mastering I/O Accelerator for PowerQUICC and Generic 32-bit, 66 MHz Local Bus" },
	...
	{ 0x10B5, 0x9080, "PCI 9080",
	  "High performance PCI to Local Bus chip" },
	...
	{ 0x10B7, 0x1000, "3C905CX-TXNM",
	  "3COM 3C905CX-TXNM with 40-0664-003 ASIC" },
	...
	{ 0x10B7, 0x5257, "3CCFE575CT",
	  "Cyclone Fast Ethernet CardBus PC Card" },
	...
	{ 0x10B7, 0x6565, "3CCFEM656C",
	  "Global 10/100 Fast Ethernet+56K Modem" },
	...
	{ 0x10B7, 0x9902, "3CR990-TX-95",
	  "EtherLink 10/100 PCI with 3XP Processor" },
	{ 0x10B7, 0x9903, "3CR990-TX-97",
	  "EtherLink 10/100 PCI with 3XP Processor" },
	{ 0x10B7, 0x9905, "3C990B-FX", "100FX PCI Server NIC w/3XP" },
	{ 0x10B7, 0x9908, "3CR990SVR95",
	  "EtherLink 10/100 Server PCI with 3XP" },
	{ 0x10B7, 0x9909, "3CR990SVR97",
	  "EtherLink 10/100 Server PCI with 3XP" },
	{ 0x10B7, 0xD004, "3C900B-TPO", "EtherLink XL PCI" },
	{ 0x10B8, 0x0005, "LAN83C170QF/171",
	  "EPIC/XF 10/100 Mbps Fast Ethernet Ctrlr" },
	{ 0x10B8, 0x0006, "LAN83C175",
	  "EPIC/C Ethernet CardBus Integrated Ctrlr" },
	...
	{ 0x10B9, 0x5237, "M5273 A1 for windows 98",
	  "OpenHCI 1.1 USB to  2.0" },
	...
	{ 0x10B9, 0X5459, "MDV92XP NetoDragon",
	...
	{ 0x10C8, 0x0083, "NM2097",
	  "Graphic Controller NeoMagic MagicGraph128ZV+" },
	...
	{ 0x10D9, 0x0531, "MX98715/25",
	  "Single Chip Fast Ethernet NIC Controller" },
	{ 0x10D9, 0x0532, "MX98723/727",
	...
	{ 0x10DC, 0x0002, "ATT 2C15-3 (FPGA)",
	  "SCI bridge  on PCI 5 Volt card" },
	{ 0x10DC, 0x0004, "EP20S780", "ALTERA STRATIX" },
	{ 0x10DC, 0x0010, "680-1110-150/400",
	  "Simple PMC/PCI to S-LINK interface" },
	{ 0x10DC, 0x0011, "680-1110-200/450",
	  "Simple S-LINK to PMC/PCI interface" },
	...
	{ 0x10DC, 0x324, "PLX PCI96556",
	  "64 Bit/66MHz PCI to Local Bus Bridge" },
	{ 0x10DD, 0x0001, "", "3D graphics processor" },
	{ 0x10DE, 0x04EF, "NV3", "Riva 128" },
	{ 0x10DE, 0x0001, "Lucent 0x00da",
	  "SoundMAX Integrated Digital Audio" },
	...
	{ 0x10DE, 0x0057, "nForce4 Ultra",
	  "NVidia Network Bus Enumerator Description du p���riph���rique	nVIDIA nForce4 SLI (CK8-04) - LAN Controll" },
	...
	{ 0x10DE, 0x006B, "nForce MCP-T?",
	  "Audio Processing Unit (Dolby Digital)" },
	{ 0x10DE, 0x006C, "nForce", "PCI to PCI Bridge" },
	{ 0x10DE, 0x006D, "nForce MCP-T", "Audio Codec Interface" },
	{ 0x10DE, 0x006E, "nForce MCP2",
	...
	{ 0x10DE, 0x036d, "81FB1043",
	  "Standard PCI-to-USB Enhanced Hostcontroller" },
	...
	{ 0x10DE, 0x0402, "0402",
	  "gainward bliss 8600 gt 512mo silent fx pcx" },
	...
	{ 0x10DF, 0xF0A5, "PL1050Ex",
	  "Emulex 1050EX FC HBA - 2GB PCI-EXPRESS" },
	...
	{ 0x10F6, 0x0111, "PCIVEN",
	  "CMI8738/C3DX Multimedia Audio Controller" },
	...
	{ 0x1102, 0x0004, "Creative SB Audigy 2 ZS (WDM)",
	  "Audigy Audio Processor" },
	...
	{ 0x1106, 0x3065, "VT6102",
	  "Rhine II PCI Fast Ethernet Controller||Used by GERICOM in laptop Webengine Advanced" },
	...
	{ 0x1106, 0x3106, "VT6105M/LOM",
	  "Rhine III PCI Fast Ethernet Controller" },
	...
	{ 0x1106, 0x3288, "040300",
	  "VIA VT8251/8237A High Definition Audio Controller - HDA Codec Realtek ALC660" },
	...
	{ 0x13EA, 0x3134, "DS3134",
	  "Chateau Channelized T1/E1/HDLC Controller" },
	...
	{ 0x14D9, 0x0010, "AP1011/SP1011",
	  "Sturgeon HyperTransport-PCI Bridge" },
	...
	{ 0x14E4, 0x170C, "BCM4401",
	  "Broadcom NetLink 4401 10/100 Ethernet NIC" },
	...
	{ 0x14E4, 0x3352, "BCM3352",
	  "BCM3352 QAMLink��?Single-Chip 4-Line VoIP" },
	{ 0x14E4, 0x3360, "BCM3360",
	  "Advanced PHY Broadband Gateway Cable Modem" },
	{ 0x14E4, 0x4211, "BCM HPNA", "10Mb/s NIC" },
	{ 0x14E4, 0x4212, "BCM V.90", "56k Modem" },
	{ 0x14E4, 0x4301, "BCM4301 802.11b",
	  "Dell Truemobile 1180 802.11b MiniPCI" },
	...
	{ 0x14E4, 0x4310, "BCM4310",
	  "BCM4301 802.11bChipcommon I/O Controller" },
	...
	{ 0x14E4, 0x5600, "BCM5600",
	  "StrataSwitch 24+2 Ethernet Switch Controller" },
	{ 0x14E4, 0x5605, "BCM5605",
	  "StrataSwitch 24+2 Ethernet Switch Controller" },
	{ 0x14E4, 0x5615, "BCM5615",
	  "StrataSwitch 24+2 Ethernet Switch Controller" },
	{ 0x14E4, 0x5625, "BCM5625",
	  "StrataSwitch 24+2 Ethernet Switch Controller" },
	{ 0x14E4, 0x5645, "BCM5645",
	  "StrataSwitch 24+2 Ethernet Switch Controller" },
	...
	{ 0x14E4, 0x5802, "BCM5802",
	  "The BCM5802 Security Processor integrates Broadcom���s IPSec engine (DES, 3DES, HMAC-SHA-1, HMAC-MD5)," },
	{ 0x14E4, 0x5805, "BCM5805",
	  "The BCM5805 Security Processor integrates a high-performance IPSec engine (DES, 3DES, HMAC-SHA-1, HM" },
	...
	{ 0x1516, 0x0803, "Myson MTD803/TAMARACK TC6020",
	  "PCI Ethernet controller" },
	{ 0x1516, 0x0891, "MTD891",
	...
	{ 0x1119, 0x0001, "GDT6000/6010",
	  "PCI 1-channel SCSI RAID Controller" },
	{ 0x1119, 0x0002, "GDT6110/6510",
	  "PCI 1-channel SCSI RAID Controller" },
	{ 0x1119, 0x0003, "GDT6120/6520",
	  "PCI 2-channel SCSI RAID Controller" },
	...
	{ 0x1119, 0x016A, "GDT7538RN/7638RN",
	  "64-bit PCI Wide Ultra2 SCSI HBA" },
	{ 0x1119, 0x016B, "GDT7558RN/7658RN",
	  "64-bit PCI Wide Ultra2 SCSI HBA" },
	...
	{ 0x1131, 0x7133, "Pinnacle PCTV 110i",
	...
	{ 0x1148, 0x4300, "SysKonnect Genesis",
	  "SK-NET Gigabit Ethernet Adapter" },
	...
	{ 0x1169, 0x2001, "Ql5032-33APQ208C",
	  "PCI to C-DAC RTU bus interface FPGA" },
	...
	{ 0x1186, 0x1002, "DFE-550TX/580TX/DFE-550FX",
	...
	{ 0x118C, 0x1117, "MAC-94C201B3",
	  "Corollary/Intel Memory Controller Chip" },
	...
	{ 0x1191, 0x0002, "ATP850UF",
	  "UltraDMA33 EIDE Controller (AEC6210UF)" },
	...
	{ 0x1191, 0x000a, "aec6885",
	  "ACARD AEC-6885/6895/6896 RAID Controller" },
	{ 0x1191, 0x000B, "AEC6897/6898",
	  "ACARD AEC-6897/6898 RAID Controller" },
	{ 0x1191, 0x000D, "ATP8620",
	  "2S1P PCI-X SATA(3G)/UDMA Combo Controller" },
	{ 0x1191, 0x8001, "ATP8600",
	  "SCSI-2 RAID (cache?) Adapter (AEC6820U)" },
	...
	{ 0x11AB, 0x0146, "GT-64010/A",
	  "System Ctrlr for R4xxx/5000 Family CPUs" },
	...
	{ 0x11AB, 0x1FAA, "8335",
	  "Marvell Libertas 802.11b/g Wireless (8335)" },
	...
	{ 0x11AB, 0x4363, "88E8053",
	  "Yukon PCI-E Gigabit Ethernet Controller" },
	{ 0x11AB, 0x4364, "88E8056",
	  "Yukon PCI-E Gigabit Ethernet Controller" },
	...
	{ 0x11AB, 0x6145, "88SE6145",
	  "Add-on IC to provide 4x SATA Ports, attached to ICH7 (SthBridge?) via PCI-Express." },
	...
	{ 0x11AB, 0xF004, "GT64120",
	  "Primary Image Barracuda Image Generator" },
	...
	{ 0x11C1, 0x0451, "LT Winmodem",
	  "LT WinModem 56k Data+Fax+Voice+DSVD" },
	...
	{ 0x11C1, 0x5803, "USS-344",
	  "QuadraBus 4-port USB OpenHCI Host Ctrlr" },
	...
	{ 0x11D5, 0x0115, "10115",
	  "Versatec Parallel Interface (VPI) + Centronics" },
...
int PCI_DEVTABLE_LEN = (sizeof(PciDevTable) / sizeof(PCI_DEVTABLE));

PCI_CLASSCODETABLE PciClassCodeTable[] = {
	{ 0x00, 0x00, 0x00, "Pre-2.0 PCI Specification Device", "Non-VGA", "" },
	{ 0x00, 0x01, 0x00, "Pre-2.0 PCI Specification Device",
	  "VGA Compatible", "" },
	...
	{ 0x08, 0x01, 0x00, "Base Systems Peripheral",
	  "DMA (Direct Memory Access)", "Generic 8259" },
	{ 0x08, 0x01, 0x01, "Base Systems Peripheral",
	  "DMA (Direct Memory Access)", "ISA" },
	{ 0x08, 0x01, 0x02, "Base Systems Peripheral",
	  "DMA (Direct Memory Access)", "EISA" },
	...
	{ 0x0C, 0x03, 0x00, "Serial Bus Controller",
	  "USB (Universal Serial Bus)", "" },
	{ 0x0C, 0x04, 0x00, "Serial Bus Controller", "Fibre Channel", "" },

	{ 0xFF, 0x00, 0x00, "Unknown", "Device Does Not Fit In Class Codes",
	  "UDF" },
};

// Use this value for loop control during searching:
int PCI_CLASSCODETABLE_LEN =
	(sizeof(PciClassCodeTable) / sizeof(PCI_CLASSCODETABLE));

const char *PciCommandFlags[] = { "I/O Access",
				  "Memory Access",
				  "Bus Mastering",
				  "Special Cycles",
...
// Use this value for loop control during searching:
int PCI_COMMANDFLAGS_LEN = (sizeof(PciCommandFlags) / sizeof(char *));

const char *PciStatusFlags[] = { "Reserved 0",
				 "Reserved 1",
				 "Reserved 2",
				 "Reserved 3",
				 "Reserved 4",
...
// Use this value for loop control during searching:
int PCI_STATUSFLAGS_LEN = (sizeof(PciStatusFlags) / sizeof(char *));

const char *PciDevSelFlags[] = { "Fast Devsel Speed", // TypeC
				 "Medium Devsel Speed", // TypeB
				 "Slow Devsel Speed", // TypeA
				 "Reserved 9&10" };

// Use this value for loop control during searching:
int PCI_DEVSELFLAGS_LEN = (sizeof(PciDevSelFlags) / sizeof(char *));
