...
int PCI_CLASSCODETABLE_LEN = (sizeof(PciClassCodeTable) / sizeof(PCI_CLASSCODETABLE));

const char* PciCommandFlags[] = {
        "I/O Access",    "Memory Access", "Bus Mastering", "Special Cycles", "Memory Write & Invalidate",
        "Palette Snoop", "Parity Errors", "Wait Cycles",   "System Errors",  "Fast Back-To-Back",
