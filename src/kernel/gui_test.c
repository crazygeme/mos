...
static void gui_test_draw_shell()
{
	...
	y_off = 40;
	gui_fill_rectange_gradually(x_off, y_off - 20, width, 20,
				    VGA_COLOR_BLACK, VGA_COLOR_GRAY);
	gui_fill_rectangle_alpha(x_off, y_off, width, height, VGA_COLOR_BLACK,
				 0.8);
...
{
	gui_fill_rectange_gradually(0, MAX_Y - 40, MAX_X, 20, VGA_COLOR_GRAY,
				    0x00666666);
	gui_fill_rectange_gradually(0, MAX_Y - 20, MAX_X, 20, 0x00666666,
				    VGA_COLOR_GRAY);
}
